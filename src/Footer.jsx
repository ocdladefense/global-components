              ...
              <ul class="flex flex-col gap-1">
                ...
                <li>
                  <ul class="flex items-center gap-1">
                    ...
                    {showTwitter ? (
                      <Social type="twitter" handle="oregondefense" />
                    ) : (
                      <></>
                    )}
                    {showYouTube ? (
                ...
                <li>
                  <ul class="text-[0.625rem] font-thin leading-[0.75rem] text-neutral-500">
                    ...
                    <li class="size-full text-wrap">
                      Oregon Criminal Defense Lawyers Association is a 501(c)(3)
                      nonprofit educational association. Contributions to OCDLA
                      may be tax deductible - check with your tax advisor.
                      Electronic downloads are for the sole use of the
                      purchasing member. Files may not be distributed to others.
                    </li>
                  </ul>
                </li>
                {/* Contact */}
                <li>
                  <ul class="text-neutral-300">
                    <Link href="https://ocdla.org" label="ocdla.org" />{" "}
                    {!useGoogleMapsIFrame ? (
                      <>
                        |{" "}
                        <Link
                    ...
                    |{" "}
                    <Link href="mailto:info@ocdla.org" label="info@ocdla.org" />{" "}
                    | <Link href="tel:+15416868716" label="(+1) 541-686-8716" />
                  </ul>
                </li>
              </ul>
            </li>
              ...
              <ul class="flex flex-col gap-8 text-nowrap text-[#516490] lg:flex-row lg:gap-16">
                ...
                <li>
                  <ul class="flex flex-col gap-1">
                    ...
                    <li>
                      <Link href="/" label="CLEs" />
                    </li>
                    <li>
                      <Link href="/" label="Videos" />
                    </li>
                    <li>
                      <Link href="/" label="Seminars & Events" />
                    </li>
                  </ul>
                </li>
              </ul>
